...
CREATE TABLE IF NOT EXISTS users (
    ...
    role ENUM('CLIENT', 'SUPPLIER') NOT NULL,
...
CREATE TABLE IF NOT EXISTS venues (
    ...
    city_available VARCHAR(255) NOT NULL,
    service_price_guest DECIMAL(10, 2),
    service_price_hour DECIMAL(10, 2),
    picture VARCHAR(255),
    description TEXT,
    user_id INT,
    hours TEXT,
    limited_by_price_per_guest BOOLEAN NOT NULL,
    limited_by_price_per_hour BOOLEAN NOT NULL,
    fixed_price DECIMAL(10, 2),
    FOREIGN KEY (user_id) REFERENCES users(id)
);

-- Crear tabla de otros servicios
CREATE TABLE IF NOT EXISTS other_services (
    id INT AUTO_INCREMENT PRIMARY KEY,
    other_service_type VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS events (
    id INT AUTO_INCREMENT PRIMARY KEY,
    event_type ENUM('WEDDING', 'CHRISTENING', 'COMMUNION', 'OTHER') NOT NULL,
    guests INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS ratings (
    ...
    comment TEXT,
    FOREIGN KEY (user_id) REFERENCES users(id),
    FOREIGN KEY (other_service_id) REFERENCES other_services(id),
    FOREIGN KEY (venue_id) REFERENCES venues(id)
);

-- Crear tabla de event_properties
CREATE TABLE IF NOT EXISTS event_properties (
    id INT AUTO_INCREMENT PRIMARY KEY,  -- ID auto-incrementable
    event_id INT,
    other_service_id INT,               -- Relación con OtherService
    venue_id INT,                       -- Relación con Venue
    approved BOOLEAN,                   -- Aprobado o no
