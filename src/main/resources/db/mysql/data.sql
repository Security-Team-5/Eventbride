...
-- More suppliers
(25, 'FloresDelSur', 'SUPPLIER', 'info@floresdelsur.com', 'Floristería', 'Del Sur', '954123456', '67890123F', 'https://images.unsplash.com/photo-1561181286-d5c92b900f59', '$2a$10$gyqEuh5bpJVhwuN44YwkjeaR6/1u2KqFTGhjYxWtH27Dmka569AmK', "PREMIUM", '2025-04-15', '2026-04-15', true),
...
(29, 'InvitacionesElegantes', 'SUPPLIER', 'pedidos@invitacioneselegantes.com', 'Invitaciones', 'Elegantes', '958567890', '01234567J', 'https://images.unsplash.com/photo-1607344645866-009c320c5ab8', '$2a$10$gyqEuh5bpJVhwuN44YwkjeaR6/1u2KqFTGhjYxWtH27Dmka569AmK', "PREMIUM", '2025-06-20', '2026-06-20', false);

-- Additional VENUES
INSERT IGNORE INTO venues (id, postal_code, coordinates, address, max_guests, surface, name, available, city_available, service_price_guest, service_price_hour, picture, description, user_id, limited_by_price_per_guest, limited_by_price_per_hour, fixed_price, earliest_time, latest_time) VALUES 
(8, '41003', '37.386123, -5.991234', 'Av. de la Constitución, 12', 300, 450.00, 'Palacio de Cristal', TRUE, 'Sevilla', null, 500.00, 'https://images.unsplash.com/photo-1519167758481-83f550bb49b3', 'Elegante palacio con amplios salones y jardines para celebraciones exclusivas. Ubicado en el centro histórico de Sevilla, ofrece un entorno único con vistas panorámicas a la ciudad.', 25, FALSE, TRUE, null, '10:00:00', '02:00:00'),
...
(12, '41007', '37.405678, -5.958901', 'Av. de la Palmera, 56', 250, 350.00, 'Villa Los Naranjos', TRUE, 'Sevilla', null, 450.00, 'https://images.unsplash.com/photo-1604014056465-3e2fe51e9223', 'Hermosa villa rodeada de naranjos y jardines. Cuenta con salones interiores y espacios exteriores para celebraciones durante todo el año.', 29, FALSE, TRUE, null, '10:00:00', '22:00:00');
