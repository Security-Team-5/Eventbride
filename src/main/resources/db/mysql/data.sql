...
INSERT IGNORE INTO venues (id, postal_code, coordinates, address, max_guests, surface, name, available, city_available, service_price_guest, service_price_hour, picture, description, user_id, limited_by_price_per_guest, limited_by_price_per_hour, fixed_price) VALUES 
(1, '41001', '37.388630, -5.982430', 'Calle Sierpes, 1', 110, 100.00, 'Castillo de Maxi' ,TRUE, 'Sevilla', 1000.00, null, 'https://www.guiacatering.com/site/company/a7/1176/images/366309/el-castillo-de-maxi_ci3.jpg', '¿Sabías que entre nuestros servicios se encuentra la posibilidad de disfrutar de un castillo hinchable? ¡Los más pequeños se lo pasarán en grande!', 6, TRUE, FALSE, null),
(2, '41002', '37.388630, -5.982430', 'Calle Sierpes, 2', 200, 180.00, 'Mongo Mangos' ,TRUE, 'Sevilla', null, 400.00,'https://vientosolar.org/wp-content/uploads/2016/03/bpp8409a-401x249.jpg', 'Proporcionamos un lugar apegado a la naturaleza para que puedas disfrutar de un evento inolvidable.', 14, FALSE, TRUE, null);
...
(6, 'ENTERTAINMENT', 'Sonido para eventos',  'Master Sound' ,TRUE, 'Sevilla', null, 200.00, 'https://thumbs.static-thomann.de/thumb/padthumb600x600/pics/bdb/_54/545096/17370601_800.jpg', 'Convierte tus eventos en experiencias inolvidables. Con un estilo único y creativo, el decorador de eventos transforma espacios en escenarios de ensueño, llenos de color, texturas y detalles que reflejan tu personalidad y estilo.', 12, FALSE, TRUE, null),
...
(1, 'WEDDING', 120, 1100.00, '2023-12-31', '2023-08-31', 115, TRUE, 1),
(2, 'CHRISTENING', 50, 500.00, '2023-12-31', '2023-10-31', 40, TRUE, 2),
(3, 'WEDDING', 200, 1700.00, '2023-12-31', '2023-08-31', 190, TRUE, 3),
(4, 'COMMUNION', 100, 900.00, '2023-12-31', '2023-11-30', 90, TRUE, 4),
(5, 'WEDDING', 100, 10000.00, '2023-12-31', '2023-08-31', 90, TRUE, 5),
(6, 'WEDDING', 100, 10000.00, '2023-06-30', '2023-02-28', 90, TRUE, 1),
(7, 'CHRISTENING', 50, 5000.00, '2023-07-30', '2023-05-30', 40, TRUE, 2),
(8, 'COMMUNION', 30, 3000.00, '2023-08-30', '2023-07-30', 25, TRUE, 3),
(9, 'WEDDING', 200, 20000.00, '2023-09-30', '2023-05-30', 190, TRUE, 4),
(10, 'CHRISTENING', 100, 11000.00, '2023-10-30', '2023-08-30', 90, TRUE, 5);
...
INSERT IGNORE INTO event_properties (id, event_id, other_service_id, venue_id, approved, request_date, hours) VALUES
(1, 1, 1, null, TRUE, '2023-12-01', null),
(2, 1, 2, null, TRUE, '2023-12-01', 5),
(3, 1, null, 1, TRUE, '2023-12-01', null),

(4, 2, 1, null, TRUE, '2023-12-02', null),
(5, 2, 3, null, TRUE, '2023-12-02', 4),
(6, 2, 6, null, TRUE, '2023-12-02', 4),
(7, 2, null, 1, TRUE, '2023-12-02', null),

(8, 3, 1, null, TRUE, '2023-12-03', null),
(9, 3, 4, null, TRUE, '2023-12-03', 3),
(10, 3, 6, null, TRUE, '2023-12-03', 6),
(11, 3, null, 1, TRUE, '2023-12-03', null),

(12, 4, 5, null, TRUE, '2023-12-04', null),
(13, 4, 6, null, TRUE, '2023-12-04', 4),
(14, 4, 7, null, TRUE, '2023-12-04', null),
(15, 4, null, 2, TRUE, '2023-12-04', null),

(16, 5, 2, null, TRUE, '2023-12-02', 3),
(17, 5, 5, null, TRUE, '2023-12-02', null),
(18, 5, 6, null, TRUE, '2023-12-02', 6),
(19, 5, null, 2, TRUE, '2023-12-02', null),

(20, 6, 1, null, TRUE, '2023-05-30', null),
(21, 6, 2, null, TRUE, '2023-05-30', 4),
(22, 6, null, 1, TRUE, '2023-05-30', null),

(23, 7, 1, null, TRUE, '2023-06-30', null),
(24, 7, 3, null, TRUE, '2023-06-30', 4),
(25, 7, null, 1, TRUE, '2023-06-30', null),

(26, 8, 4, null, TRUE, '2023-07-30', 5),
(27, 8, 5, null, TRUE, '2023-07-30', null),
(28, 8, null, 1, TRUE, '2023-07-30', null),

(29, 9, 5, null, TRUE, '2023-08-30', null),
(30, 9, 7, null, TRUE, '2023-08-30', null),
(31, 9, null, 2, TRUE, '2023-08-30', null),

(32, 10, 3, null, TRUE, '2023-09-30', 5),
(33, 10, 5, null, TRUE, '2023-09-30', null),
(34, 10, null, 2, TRUE, '2023-09-30', null);