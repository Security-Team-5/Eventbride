    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**", "/api/users/auth/register","/api/users/auth/login", "/api/venues/**", "/api/users/auth/current-user", "/api/v1/events/**", "/api/other-services/**", "/api/venues/**", "/api/services/**").permitAll() // Permite el acceso a estas rutas
